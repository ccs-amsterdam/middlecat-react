 ...
 * @returns
 */
function createMiddlecatUser(access_token, refresh_token, storeToken, setUser) {
    var _this = this;
    if (!access_token)
        return undefined;
    var payload = (0, jwt_decode_1.default)(access_token);
    var api = (0, selfRefreshingAxios_1.default)(payload.resource, access_token, refresh_token, storeToken, setUser);
