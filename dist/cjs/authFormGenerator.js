...
function authFormGenerator(_a) {
    ...
    var AuthForm = function (_a) {
        ...
        function ConditionalRender() {
            ...
            if (!user)
                return ((0, jsx_runtime_1.jsx)(SignInForm, { signIn: signIn, resourceLabel: resourceLabel, resourceExample: resourceExample, resourceSuggestion: resourceSuggestion, resourceFixed: resourceFixed, signInLabel: signInLabel }));
...
function SignInForm(_a) {
    ...
    var _b = (0, react_1.useState)(resourceFixed || resourceSuggestion || ""), resourceValue = _b[0], setResourceValue = _b[1];
