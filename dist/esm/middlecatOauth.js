        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("".concat(safeURL(resource), "/middlecat"))];
                case 1:
                    res = _a.sent();
...
export function authorizationCode(resource, code, state, bff) {
    return __awaiter(this, void 0, void 0, function () {
...
export function refreshToken(middlecat, refresh_token, resource, bff) {
    return __awaiter(this, void 0, void 0, function () {
        var body, url, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
 ...
 */
export function killMiddlecatSession(middlecat, refresh_token, signOutMiddlecat, resource, bff, setUser) {
    return __awaiter(this, void 0, void 0, function () {
        var body, url;
        return __generator(this, function (_a) {
            switch (_a.label) {
