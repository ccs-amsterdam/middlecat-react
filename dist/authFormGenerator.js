...
function authFormGenerator(_a) {
    ...
    var AuthForm = function (_a) {
        ...
        return ((0, jsx_runtime_1.jsx)(AuthContainer, __assign({ primary: primary, secondary: secondary }, { children: (0, jsx_runtime_1.jsx)(ConditionalRender, {}) })));
    };
...
function SignOutForm(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", __assign({ className: "User" }, { children: [(user === null || user === void 0 ? void 0 : user.image) ? ((0, jsx_runtime_1.jsx)("img", { className: "Image", src: user.image, "referrer-policy": "no-referrer", alt: "" })) : null, (0, jsx_runtime_1.jsxs)("div", { children: [(user === null || user === void 0 ? void 0 : user.name) || (user === null || user === void 0 ? void 0 : user.email), (user === null || user === void 0 ? void 0 : user.name) ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsx)("span", __assign({ style: { fontSize: "1.2rem" } }, { children: user === null || user === void 0 ? void 0 : user.email }))] })) : null] })] })), (0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsxs)("div", __assign({ className: "SignOut" }, { children: [(0, jsx_runtime_1.jsx)("button", __assign({ onClick: function () { return signOut(false); } }, { children: signOutLabel || "Sign-out" })), (0, jsx_runtime_1.jsx)("button", __assign({ onClick: function () { return signOut(true); } }, { children: "Sign-out MiddleCat" }))] }))] }));
}
