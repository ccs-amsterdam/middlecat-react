...
export default function authFormGenerator(_a) {
    ...
    var AuthForm = function (_a) {
        ...
        function ConditionalRender() {
            ...
            if (!user)
                return (_jsx(SignInForm, { fixedResource: fixedResource, signIn: signIn, resourceLabel: resourceLabel, resourceExample: resourceExample, resourceSuggestion: resourceSuggestion, signInLabel: signInLabel }));
...
function SignInForm(_a) {
    ...
    var _b = useState(fixedResource || resourceSuggestion || ""), resourceValue = _b[0], setResourceValue = _b[1];
    ...
    return (_jsxs("form", __assign({ onSubmit: function (e) {
        ...
        } }, { children: [fixedResource ? (_jsx("h3", { children: fixedResource })) : (_jsxs(_Fragment, { children: [_jsx("label", { children: _jsx("b", { children: resourceLabel || "Connect to server" }) }), _jsx("input", { type: "url", id: "url", name: "url", placeholder: resourceExample || "https://amcat-server.example", value: resourceValue, onChange: function (e) { return setResourceValue(e.target.value); } })] })), _jsx("button", __assign({ disabled: invalidUrl(resourceValue), type: "submit" }, { children: signInLabel || "Sign-in" }))] })));
}
function SignOutForm(_a) {
    var user = _a.user, signOut = _a.signOut, signOutLabel = _a.signOutLabel;
    return (_jsxs(_Fragment, { children: [_jsxs("div", __assign({ className: "User" }, { children: [(user === null || user === void 0 ? void 0 : user.image) ? (_jsx("img", { className: "Image", src: user.image, "referrer-policy": "no-referrer", alt: "" })) : null, _jsxs("div", { children: [(user === null || user === void 0 ? void 0 : user.name) || (user === null || user === void 0 ? void 0 : user.email), (user === null || user === void 0 ? void 0 : user.name) ? (_jsxs(_Fragment, { children: [_jsx("br", {}), _jsx("span", __assign({ style: { fontSize: "1.2rem" } }, { children: user === null || user === void 0 ? void 0 : user.email }))] })) : null] })] })), _jsx("br", {}), _jsxs("div", __assign({ className: "SignOut" }, { children: [_jsx("button", __assign({ onClick: function () { return signOut(false); } }, { children: signOutLabel || "Sign-out" })), _jsx("button", __assign({ onClick: function () { return signOut(true); } }, { children: "Sign-out MiddleCat" }))] }))] }));
}
